...
function Modal({ setOpenModal , start ,performNewRdv }) {
  ...
  const onSubmit = (form) => {
    ...
    const consultationData = {
      ...
      id_medcin: "6570666e932fe08092d2525d", 
      // id_doc: "3", 
      patient: "657b0a90eab68016d41a8d85", 
      startDate: formData.hour,
      // endDate: (formData.hour),
    };
